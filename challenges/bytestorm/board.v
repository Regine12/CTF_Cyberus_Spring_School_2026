...
reg  main_basesoc_debug_reset = 1'd0;
reg  main_basesoc_i_jtag_tdi = 1'd0;
reg  main_basesoc_i_jtag_tms = 1'd0;
reg  main_basesoc_i_jtag_tck = 1'd0;
wire main_basesoc_o_jtag_tdo;
wire main_basesoc_o_resetOut;
reg  main_basesoc_reset_debug_logic = 1'd0;
...
reg  [15:0] main_leds_storage = 16'd0;
reg  main_leds_re = 1'd0;
reg  [15:0] main_leds_chaser = 16'd0;
reg  main_leds_mode = 1'd0;
wire main_leds_wait;
wire main_leds_done;
reg  [21:0] main_leds_count = 22'd2343750;
reg  [15:0] main_leds_leds = 16'd0;
reg  main_jtag_lock_storage = 1'd0;
reg  main_jtag_lock_re = 1'd0;
reg  main_jtag_status_status = 1'd0;
wire main_jtag_status_we;
reg  main_jtag_status_re = 1'd0;
reg  main_dummy_tdi = 1'd0;
reg  main_dummy_tms = 1'd0;
reg  main_dummy_tck = 1'd0;
reg  main_counter_start_storage = 1'd0;
reg  main_counter_start_re = 1'd0;
wire [31:0] main_counter_value_status;
wire main_counter_value_we;
reg  main_counter_value_re = 1'd0;
reg  [31:0] main_counter_count = 32'd0;
reg  main_counter_running = 1'd0;
reg  [2:0] main_keypad_counter = 3'd0;
reg  [3:0] main_keypad_state = 4'd0;
reg  [15:0] main_keypad_value = 16'd0;
reg  main_keypad_status = 1'd0;
wire main_keypad_we;
reg  main_keypad_re = 1'd0;
wire [3:0] main_keypad_key;
wire [6:0] main_keypad_seg0;
wire [6:0] main_keypad_seg1;
wire [6:0] main_keypad_seg2;
wire [6:0] main_keypad_seg3;
...
wire builder_csr_bankarray_csrbank0_control0_r;
reg  builder_csr_bankarray_csrbank0_control0_we = 1'd0;
wire builder_csr_bankarray_csrbank0_control0_w;
...
reg  builder_csr_bankarray_csrbank2_jtag_lock0_re = 1'd0;
wire builder_csr_bankarray_csrbank2_jtag_lock0_r;
reg  builder_csr_bankarray_csrbank2_jtag_lock0_we = 1'd0;
wire builder_csr_bankarray_csrbank2_jtag_lock0_w;
reg  builder_csr_bankarray_csrbank2_jtag_status_re = 1'd0;
wire builder_csr_bankarray_csrbank2_jtag_status_r;
reg  builder_csr_bankarray_csrbank2_jtag_status_we = 1'd0;
wire builder_csr_bankarray_csrbank2_jtag_status_w;
...
wire builder_csr_bankarray_csrbank3_status_r;
reg  builder_csr_bankarray_csrbank3_status_we = 1'd0;
wire builder_csr_bankarray_csrbank3_status_w;
...
wire [15:0] builder_csr_bankarray_csrbank4_out0_r;
reg  builder_csr_bankarray_csrbank4_out0_we = 1'd0;
wire [15:0] builder_csr_bankarray_csrbank4_out0_w;
...
assign {user_led15, user_led14, user_led13, user_led12, user_led11, user_led10, user_led9, user_led8, user_led7, user_led6, user_led5, user_led4, user_led3, user_led2, user_led1, user_led0} = (main_leds_leds ^ 1'd0);
...
always @(*) begin
	...
	main_dummy_tck <= 1'd0;
	jtag_tdo <= 1'd0;
	if ((main_jtag_lock_storage == 1'd1)) begin
...
assign main_counter_value_status = main_counter_count;
always @(*) begin
...
assign builder_csr_bankarray_csrbank0_control0_r = builder_csr_bankarray_interface0_bank_bus_dat_w[0];
always @(*) begin
...
assign builder_csr_bankarray_csrbank0_control0_w = main_counter_start_storage;
assign builder_csr_bankarray_csrbank0_value_w = main_counter_value_status[31:0];
assign main_counter_value_we = builder_csr_bankarray_csrbank0_value_we;
...
assign builder_csr_bankarray_csrbank2_sel = (builder_csr_bankarray_interface2_bank_bus_adr[13:9] == 4'd10);
assign builder_csr_bankarray_csrbank2_jtag_lock0_r = builder_csr_bankarray_interface2_bank_bus_dat_w[0];
always @(*) begin
	builder_csr_bankarray_csrbank2_jtag_lock0_re <= 1'd0;
	builder_csr_bankarray_csrbank2_jtag_lock0_we <= 1'd0;
	if ((builder_csr_bankarray_csrbank2_sel & (builder_csr_bankarray_interface2_bank_bus_adr[8:0] == 1'd0))) begin
		builder_csr_bankarray_csrbank2_jtag_lock0_re <= builder_csr_bankarray_interface2_bank_bus_we;
		builder_csr_bankarray_csrbank2_jtag_lock0_we <= (~builder_csr_bankarray_interface2_bank_bus_we);
	end
end
assign builder_csr_bankarray_csrbank2_jtag_status_r = builder_csr_bankarray_interface2_bank_bus_dat_w[0];
always @(*) begin
	builder_csr_bankarray_csrbank2_jtag_status_re <= 1'd0;
	builder_csr_bankarray_csrbank2_jtag_status_we <= 1'd0;
	if ((builder_csr_bankarray_csrbank2_sel & (builder_csr_bankarray_interface2_bank_bus_adr[8:0] == 1'd1))) begin
		builder_csr_bankarray_csrbank2_jtag_status_re <= builder_csr_bankarray_interface2_bank_bus_we;
		builder_csr_bankarray_csrbank2_jtag_status_we <= (~builder_csr_bankarray_interface2_bank_bus_we);
	end
end
assign builder_csr_bankarray_csrbank2_jtag_lock0_w = main_jtag_lock_storage;
assign builder_csr_bankarray_csrbank2_jtag_status_w = main_jtag_status_status;
assign main_jtag_status_we = builder_csr_bankarray_csrbank2_jtag_status_we;
assign builder_csr_bankarray_csrbank3_sel = (builder_csr_bankarray_interface3_bank_bus_adr[13:9] == 3'd4);
assign builder_csr_bankarray_csrbank3_status_r = builder_csr_bankarray_interface3_bank_bus_dat_w[0];
always @(*) begin
...
assign builder_csr_bankarray_csrbank3_status_w = main_keypad_status;
assign main_keypad_we = builder_csr_bankarray_csrbank3_status_we;
assign builder_csr_bankarray_csrbank4_sel = (builder_csr_bankarray_interface4_bank_bus_adr[13:9] == 4'd10);
assign builder_csr_bankarray_csrbank4_out0_r = builder_csr_bankarray_interface4_bank_bus_dat_w[15:0];
always @(*) begin
...
assign builder_csr_bankarray_csrbank4_out0_w = main_leds_storage[15:0];
assign builder_csr_bankarray_csrbank5_sel = (builder_csr_bankarray_interface5_bank_bus_adr[13:9] == 3'd5);
...
assign builder_csr_bankarray_csrbank6_sel = (builder_csr_bankarray_interface6_bank_bus_adr[13:9] == 3'd6);
...
always @(posedge sys_clk) begin
	...
	main_basesoc_debug_reset <= (main_basesoc_reset_debug_logic | sys_rst);
	...
	if (main_leds_done) begin
		main_leds_chaser <= {main_leds_chaser, (~main_leds_chaser[15])};
	end
	...
	if (main_leds_wait) begin
		...
		main_leds_count <= 22'd2343750;
	end
	if (main_counter_running) begin
		main_counter_count <= (main_counter_count + 1'd1);
	end
	if ((main_counter_start_storage == 1'd1)) begin
		main_counter_running <= 1'd1;
	end
	if ((main_counter_start_storage == 1'd0)) begin
		main_counter_running <= 1'd0;
	end
	...
	if ((main_keypad_counter == 3'd4)) begin
		...
		if ((main_keypad_value[15:12] != 4'd15)) begin
			main_keypad_status <= 1'd0;
			main_keypad_value <= 1'd0;
		end
		if ((main_keypad_value[11:8] != 3'd7)) begin
			main_keypad_status <= 1'd0;
			main_keypad_value <= 1'd0;
		end
		if ((main_keypad_value[7:4] != 3'd4)) begin
			main_keypad_status <= 1'd0;
			main_keypad_value <= 1'd0;
		end
		if ((main_keypad_value[3:0] != 2'd2)) begin
			main_keypad_status <= 1'd0;
			main_keypad_value <= 1'd0;
		end
	...
	if (builder_csr_bankarray_csrbank0_control0_re) begin
		main_counter_start_storage <= builder_csr_bankarray_csrbank0_control0_r;
	end
	main_counter_start_re <= builder_csr_bankarray_csrbank0_control0_re;
	main_counter_value_re <= builder_csr_bankarray_csrbank0_value_re;
	...
	if (builder_csr_bankarray_csrbank2_sel) begin
		case (builder_csr_bankarray_interface2_bank_bus_adr[8:0])
			1'd0: begin
				builder_csr_bankarray_interface2_bank_bus_dat_r <= builder_csr_bankarray_csrbank2_jtag_lock0_w;
			end
			1'd1: begin
				builder_csr_bankarray_interface2_bank_bus_dat_r <= builder_csr_bankarray_csrbank2_jtag_status_w;
			end
		endcase
	end
	if (builder_csr_bankarray_csrbank2_jtag_lock0_re) begin
		main_jtag_lock_storage <= builder_csr_bankarray_csrbank2_jtag_lock0_r;
	end
	main_jtag_lock_re <= builder_csr_bankarray_csrbank2_jtag_lock0_re;
	main_jtag_status_re <= builder_csr_bankarray_csrbank2_jtag_status_re;
	...
	main_keypad_re <= builder_csr_bankarray_csrbank3_status_re;
	...
	if (builder_csr_bankarray_csrbank4_out0_re) begin
		main_leds_storage[15:0] <= builder_csr_bankarray_csrbank4_out0_r;
	end
	...
	if (sys_rst) begin
		...
		main_leds_storage <= 16'd0;
		main_leds_re <= 1'd0;
		main_leds_chaser <= 16'd0;
		main_leds_mode <= 1'd0;
		main_leds_count <= 22'd2343750;
		main_jtag_lock_storage <= 1'd0;
		main_jtag_lock_re <= 1'd0;
		main_jtag_status_re <= 1'd0;
		main_counter_start_storage <= 1'd0;
		main_counter_start_re <= 1'd0;
		main_counter_value_re <= 1'd0;
		main_counter_count <= 32'd0;
		main_counter_running <= 1'd0;
		main_keypad_counter <= 3'd0;
		main_keypad_state <= 4'd0;
		main_keypad_value <= 16'd0;
		main_keypad_status <= 1'd0;
		main_keypad_re <= 1'd0;
		builder_grant <= 1'd0;
...
//------------------------------------------------------------------------------
// Memory rom: 4306-words x 32-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: ---- | 
reg [31:0] rom[0:4305];
initial begin
	$readmemh("board_rom.init", rom);
end
reg [31:0] rom_dat0;
always @(posedge sys_clk) begin
...
sseg_display sseg_display(
	.hex(main_keypad_value[3:0]),
	.seg(main_keypad_seg0)
);

sseg_display sseg_display_1(
	.hex(main_keypad_value[7:4]),
	.seg(main_keypad_seg1)
);

sseg_display sseg_display_2(
	.hex(main_keypad_value[11:8]),
	.seg(main_keypad_seg2)
);

sseg_display sseg_display_3(
	.hex(main_keypad_value[15:12]),
	.seg(main_keypad_seg3)
);

sseg_mux sseg_mux(
	.clk(sys_clk),
	.dig0(main_keypad_seg0),
	.dig1(main_keypad_seg1),
	.dig2(main_keypad_seg2),
	.dig3(main_keypad_seg3),
	.rst(sys_rst),
	.an({an3, an2, an1, an0}),
	.sseg({seg6, seg5, seg4, seg3, seg2, seg1, seg0})
);
...
VexRiscv VexRiscv(
	...
	.jtag_tck(main_basesoc_i_jtag_tck),
	.jtag_tdi(main_basesoc_i_jtag_tdi),
	.jtag_tms(main_basesoc_i_jtag_tms),
	.reset(((sys_rst | main_basesoc_reset) | main_basesoc_debug_reset)),
	...
	.debug_resetOut(main_basesoc_o_resetOut),
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2024-04-11 19:09:57.
//------------------------------------------------------------------------------
