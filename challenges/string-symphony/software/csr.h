//--------------------------------------------------------------------------------
// Auto-generated by LiteX (a3a3f27) on 2024-04-11 19:18:25
//--------------------------------------------------------------------------------
...
#define CSR_COUNTER_VALUE_ADDR (CSR_BASE + 0x804L)
#define CSR_COUNTER_VALUE_SIZE 1
static inline uint32_t counter_value_read(void) {
...
/* keypad */
#define CSR_KEYPAD_BASE (CSR_BASE + 0x2000L)
#define CSR_KEYPAD_STATUS_ADDR (CSR_BASE + 0x2000L)
#define CSR_KEYPAD_STATUS_SIZE 1
static inline uint32_t keypad_status_read(void) {
...
#define CSR_JTAG_JTAG_STATUS_ADDR (CSR_BASE + 0x5004L)
